...
- [Documentación del proveedor Azure (azurerm)](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs)
...
- Usa la [configuración de dependencias de proveedores](https://developer.hashicorp.com/terraform/language/modules/develop/providers) para pasar proveedores a módulos
...
- [Guía oficial para desarrollar módulos](https://developer.hashicorp.com/terraform/language/modules/develop)
- [Gestión de proveedores en módulos](https://developer.hashicorp.com/terraform/language/modules/develop/providers)
